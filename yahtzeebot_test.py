...
def test_ev_upperbox_given():
    assert round( sim_ev_upperbox_given(n=1, dicevals=[1,1,1,1,1], rolls=1) ,2) == 5.00 
    assert round( sim_ev_upperbox_given(n=1, dicevals=[1,1,1,1,1], rolls=2) ,2) == 5.00 
    assert round( sim_ev_upperbox_given(n=1, dicevals=[1,1,1,1,2], rolls=1) ,2) == round(4 + (1/6) ,2) 
    assert round( sim_ev_upperbox_given(n=1, dicevals=[1,1,1,2,2], rolls=1) ,2) == round(3 + 2*(1/6) ,2)
    assert ev_upperbox_given(1,[1,1,1,1,1],2) == 5 
    assert ev_upperbox_given(1,[1,1,1,1,2],1) == 4 + 1/6 
    assert round( ev_upperbox_given(1,[1,1,1,2,2],3), 2) ==  round( sim_ev_upperbox_given(1,[1,1,1,2,2],3), 2)
